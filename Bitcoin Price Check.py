...
################# Colors ###############
co0 = "#444466"  # Black
co1 = "#feffff"  # Numbers (White)
co2 = "#101010"  # Title (Black)
fundo = "#303030" #Background (Black)
...
def info():
    api_link = "https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=USD,EUR,JPY,BRL"
...
l_nome = Label(frame_principal, text="Bitcoin Price Check", height=1, padx=0, relief="flat", anchor="center", font=('Arial 20 '), bg=co1, fg=co2)
